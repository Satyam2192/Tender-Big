...
const Product = () => {
  ...
  const fetchProducts = async () => {
    try {
      const response = await axios.get("/apiTender/options/alloptions?array=products");
  ...
  const addProduct = async () => {
    ...
    try {
      const response = await axios.post("/apiTender/options/products", { products: [newProduct] });
  ...
  const deleteProduct = async (product) => {
    try {
      const response = await axios.delete(`/apiTender/options/products/${product}`);
      setProducts(response.data.products);
    } catch (error) {
      console.error(error);
    }
