...
const Category = () => {
  ...
  const fetchCategories = async () => {
    try {
      const response = await axios.get("/apiTender/options/alloptions?array=categories");
  ...
  const addCategory = async () => {
    ...
    try {
      const response = await axios.post("/apiTender/options/categories", { categories: [newCategory] });
  ...
  const deleteCategory = async (category) => {
    try {
      const response = await axios.delete(`/apiTender/options/categories/${category}`);
      setCategories(response.data.categories);
    } catch (error) {
      console.error(error);
    }
