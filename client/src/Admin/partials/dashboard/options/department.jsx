...
const Department = () => {
  ...
  const fetchDepartments = async () => {
    try {
      const response = await axios.get("/apiTender/options/alloptions?array=departments");
  ...
  const addDepartment = async () => {
    ...
    try {
      const response = await axios.post("/apiTender/options/departments", { departments: [newDepartment] });
  ...
  const deleteDepartment = async (department) => {
    try {
      const response = await axios.delete(`/apiTender/options/departments/${department}`);
      setDepartments(response.data.departments);
    } catch (error) {
      console.error(error);
    }
