...
const Sector = () => {
  ...
  const fetchSectors = async () => {
    try {
      const response = await axios.get("/apiTender/options/alloptions?array=sectors");
  ...
  const addSector = async () => {
    ...
    try {
      const response = await axios.post("/apiTender/options/sectors", { sectors: [newSector] });
  ...
  const deleteSector = async (sector) => {
    try {
      const response = await axios.delete(`/apiTender/options/sectors/${sector}`);
      setSectors(response.data.sectors);
    } catch (error) {
      console.error(error);
    }
