...
function CompanyForm({ onSubmit, licenses }) {
    ...
    const getAmount=async()=>{
        const {data:{price}} = await axios.get("/apiTender/formprice/Company%20Certification/price");
        return price;
    }
...
function IndividualForm({ onSubmit, licenses }) {
    ...
    const getAmount=async()=>{
        const {data:{price}} = await axios.get("/apiTender/formprice/Individual%20Certification/price");
        return price;
    }
...
const Certification = () => {
    ...
    const handleCompanyFormSubmit = (data) => {
        ...
        axios
            .post("/apiTender/services/ccert/certification", data, {
                headers: {
                    'auth': token
                }
            })
    ...
    const handleIndividualFormSubmit = (data) => {
        ...
        console.log(data)
        axios
            .post("/apiTender/services/icert/certification", data, {
                headers: {
                    'auth': token
                }
            })
